...
function kiemTraTaiKhoan(checkInput, idThongBao) {
    ...
    if (hopLe) {
        ...
        document.getElementById(idThongBao).innerHTML = "Xin nhập vào tối thiểu 4 ký tự và tối đa 6 ký tự";
        document.getElementById(idThongBao).style.display = "block";
        return false;
    }
}
...
function kiemTraEmail(checkInput, idThongBao) {
    ...
    if (emailHople) {
        ...
        document.getElementById(idThongBao).innerHTML = "Xin nhập vào đúng định dạng text@text.text";
        document.getElementById(idThongBao).style.display = "block";
        return false;
    }
}
...
function kiemTraTenNV(checkInput, idThongBao) {
    ...
    if (hopLe) {
        ...
        document.getElementById(idThongBao).innerHTML = "Xin nhập vào đúng định dạng";
        document.getElementById(idThongBao).style.display = "block";
        return false;
    }
}
...
function kiemTraChucVu(checkInput, idThongBao) {
    if (checkInput == "Sếp" || checkInput == "Trưởng phòng" || checkInput == "Nhân viên") {
